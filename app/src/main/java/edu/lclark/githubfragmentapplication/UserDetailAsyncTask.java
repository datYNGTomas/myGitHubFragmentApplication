...
public class UserDetailAsyncTask extends AsyncTask<String, Integer, GithubUser> {
    ...
    private final GitHubUserListener mListener;

    public interface GitHubUserListener {
        void onGitHubUserRetrieved(GithubUser user);
    }

    public UserDetailAsyncTask(GitHubUserListener mListener) {
    ...
    protected void onPostExecute(GithubUser githubUser) {
        ...
        mListener.onGitHubUserRetrieved(githubUser);
    }
}
